...
namespace RxCocoaSharp {
    public class RxNSTextField : NSTextField, IEventHandler, ITextChangedHandler {
        ...
        public event TextChangedHandler OnChangeText;

        private NSTextFieldDelegate mTextFieldDelegate;

        public RxNSTextField() : base() {
        ...
        internal class RxTextFieldDelegate : NSTextFieldDelegate {
            ...
            public RxTextFieldDelegate(RxNSTextField field) : base() {
                this.field = field;
            }

            public override void Changed(NSNotification notification) {
                base.Changed(notification);
                if (field.OnChangeText != null) {
                    field.OnChangeText(field.StringValue);
                }
            }
        }
