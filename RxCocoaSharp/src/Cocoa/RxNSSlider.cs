...
namespace RxCocoaSharp {
    public class RxNSSlider : NSSlider, IEventHandler, IDoubleValueChangeHandler {
        ...
        public event DoubleValueChangeHandler OnDoubleValueChanged;
